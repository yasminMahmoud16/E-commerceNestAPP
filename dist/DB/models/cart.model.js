...
exports.cartSchema = exports.Cart = exports.CartProduct = void 0;
...
__decorate([
    ...
    __metadata("design:type", mongoose_2.Types.ObjectId)
], CartProduct.prototype, "createdBy", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: mongoose_2.Types.ObjectId, ref: "User" }),
    __metadata("design:type", mongoose_2.Types.ObjectId)
], CartProduct.prototype, "updatedBy", void 0);
...
exports.cartSchema.index({ expiredAt: 1 }, { expireAfterSeconds: 0 });
