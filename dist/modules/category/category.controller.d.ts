import { GetAllDto, GetAllResponse, ICategory, IResponse } from 'src/common';
...
export declare class CategoryController {
    ...
    findAll(query: GetAllDto): Promise<IResponse<GetAllResponse<ICategory>>>;
    findAllArchiveBrand(query: GetAllDto): Promise<IResponse<GetAllResponse<ICategory>>>;
